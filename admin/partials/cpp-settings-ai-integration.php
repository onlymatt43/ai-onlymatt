    ...
    <table class="form-table" role="presentation">
        <tbody>
                ...
                <td>
                    <label for="cpp_ai_assistant_enabled">
                        <input 
                            ...
                            value="1"
                            <?php checked($assistant_enabled, true); ?>
                        />
            ...
            <tr>
                ...
                <td>
                    <?php 
                    $avatar_plugin_active = function_exists('is_plugin_active') && is_plugin_active('ai/om-ai-coach.php');
            ...
            <tr>
                ...
                <td>
                    <?php if (!empty($api_key) && $assistant_enabled): ?>
                        <a 
                            href="<?php echo esc_url(admin_url('admin.php?page=ai-onlymatt-assistant')); ?>" 
