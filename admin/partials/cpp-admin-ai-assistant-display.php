 ...
 *
 * Renders the chat interface for the Content Protect Pro AI assistant.
 * Assumes capability checks were already performed by the caller.
 *
...
$current_user = $cpp_ai_current_user ?? wp_get_current_user();
$stats = $cpp_ai_context['plugin']['stats'] ?? [
    'active_codes' => 0,
    'protected_videos' => 0,
    'active_sessions' => 0,
];
$api_key_configured = !empty($cpp_ai_api_key_configured);
$assistant_enabled = !empty($cpp_ai_assistant_enabled);
$module_url = isset($cpp_ai_module_url) ? $cpp_ai_module_url : plugin_dir_url(dirname(dirname(__FILE__)));
?>
...
<div class="wrap cpp-ai-assistant-page">
    ...
    <?php if (!$assistant_enabled): ?>
        <div class="notice notice-warning">
            <p><?php echo esc_html__('The AI assistant is currently disabled in settings. Enable it to start chatting.', 'content-protect-pro'); ?></p>
        </div>
    <?php endif; ?>
            ...
            <div class="cpp-ai-stats-card">
                ...
                <ul class="cpp-ai-stats-list">
                    <li>
                        ...
                        <strong><?php echo esc_html(number_format_i18n($stats['active_codes'] ?? 0)); ?></strong>
                        <?php echo esc_html__('Active Gift Codes', 'content-protect-pro'); ?>
                    </li>
                    <li>
                        <span class="dashicons dashicons-video-alt3"></span>
                        <strong><?php echo esc_html(number_format_i18n($stats['protected_videos'] ?? 0)); ?></strong>
                        <?php echo esc_html__('Protected Videos', 'content-protect-pro'); ?>
                    </li>
                    <li>
                        <span class="dashicons dashicons-admin-users"></span>
                        <strong><?php echo esc_html(number_format_i18n($stats['active_sessions'] ?? 0)); ?></strong>
            ...
            <div id="cpp-chat-messages" class="cpp-chat-messages">
                <div class="cpp-chat-message cpp-message-assistant cpp-welcome-message">
                    <div class="cpp-message-avatar">
                        <img src="<?php echo esc_url($module_url . 'generate_matt_audio/posters/yocestonlymatt.jpg'); ?>"
                             alt="Matt"
                ...
                <form id="cpp-chat-form" class="cpp-chat-form">
                    ...
                    <div class="cpp-input-wrapper">
                        <textarea
                            ...
                            rows="1"
                            maxlength="2000"
                            <?php echo (!$api_key_configured || !$assistant_enabled) ? 'disabled' : ''; ?>
                        ></textarea>
